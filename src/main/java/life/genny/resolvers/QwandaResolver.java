...
//	};
	...
	public static DataFetcher activeNodeInstancesFetcher = env-> {
		...
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().findActiveNodeInstances(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				(int) args.get("page"),
				(int) args.get("pageSize"), 
				res->{
	...
	public static DataFetcher completedNodeInstancesFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().findCompletedNodeInstances(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				(int) args.get("page"),
				(int) args.get("pageSize"), 
	...
	public static DataFetcher findNodeInstancesFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().findNodeInstances(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				(int) args.get("page"),
				(int) args.get("pageSize"), 
	...
	public static DataFetcher findVariableHistoryFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().findVariableHistory(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				(String) args.get("variableName"),
				(int) args.get("page"),
				(int) args.get("pageSize"), 
				res->{
					fut.complete(res.result().getList());
	...
	public static DataFetcher findVariablesCurrentStateFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().findVariablesCurrentState(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				res->{
					fut.complete(res.result().getList());
	...
	public static DataFetcher getProcessDefinitionFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().getProcessDefinition(
				(String) args.get("containerId"),
				(String) args.get("processId"), 
				res->{
	...
	public static DataFetcher getProcessInstanceFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().getProcessInstance(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				res->{
					fut.complete(res.result().getMap());
	...
	public static DataFetcher getServiceTaskDefinitionsFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().getServiceTaskDefinitions(
				(String) args.get("containerId"),
				(String) args.get("processId"), 
				res->{
					fut.complete(res.result().getMap());
	...
	public static DataFetcher getUserTaskDefinitionsFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().getUserTaskDefinitions(
				(String) args.get("containerId"),
				(String) args.get("processId"), 
				res->{
					fut.complete(res.result().getMap());
	...
	public static DataFetcher getAssociatedEntityDefinitionsFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().getAssociatedEntityDefinitions(
				(String) args.get("containerId"),
				(String) args.get("processId"), 
				res->{
					fut.complete(res.result().getMap());
	...
	public static DataFetcher getWorkItemFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().getWorkItem(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				(Long) args.get("id"), 
				res->{
	...
	public static DataFetcher startProcessFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().startProcess(
				(String) args.get("containerId"),
				(String) args.get("processId"), 
				res->{
					fut.complete(res.result().getMap());
	...
	public static DataFetcher startProcessWithVarsFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().startProcessWithVars(
				(String) args.get("containerId"),
				(String) args.get("processId"), 
				(JsonObject) args.get("variables"), 
				res->{
					fut.complete(res.result().getMap());
				}
		);
	...
	public static DataFetcher completeWorkItemFetcher = env-> {
		...
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().completeWorkItem(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				(Long) args.get("id"), 
				ob, 
	...
	public static DataFetcher getWorkItemByProcessInstanceFetcher = env-> {
		Map args = env.getArguments();
		CompletableFuture fut = new CompletableFuture<>();
		ClientServices.getService().getWorkItemByProcessInstance(
				(String) args.get("containerId"),
				(Long) args.get("processInstanceId"), 
				res->{
					fut.complete(res.result().getList());
